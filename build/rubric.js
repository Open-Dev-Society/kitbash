 ...
 */
export function buildRubric(i) {
    const constraints = [];
    if (i.stack) {
        constraints.push(`TARGET STACK: ${i.stack}\n` +
    ...
    if (i.target_license) {
        constraints.push(`TARGET LICENSE: ${i.target_license}\n` +
